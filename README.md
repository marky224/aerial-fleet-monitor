...
> Real-time fleet operations console — built on public US aviation data as a stand-in for private fleet telemetry.
...
The project demonstrates a Mission Success / Success Systems toolchain — telemetry visualization, anomaly detection, CRM-backed case management, and bidirectional sync between an operational data plane and a CRM plane.
